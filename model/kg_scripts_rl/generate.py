...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_load_dir', default='../../preprocessed_data/data/data_med/test_data.pkl', type=str, required=False)
    parser.add_argument('--pred_save_dir', default='Results/no_kg/med/pred.txt', type=str, required=False)
    parser.add_argument('--reference_save_dir', default='Results/no_kg/med/reference.txt', type=str, required=False)
    parser.add_argument('--metric_save_dir', default='Results/no_kg/med/scores.txt', type=str, required=False)
    parser.add_argument('--output_save_dir', default='Results/no_kg/med/Out.csv', type=str, required=False)
    ...
    for batch_id, batch in enumerate(test_dataloader):
        with torch.no_grad():
            ...
            encoder_input, decoder_input, mask_encoder_input, _, kg_enc_input, entity = batch
            ...
            for i in range(100):
                ...
                logits = model.pointer(encoder_input, entity, kg_enc_input, out)
                logits = logits[:, -1]
